...
--  Integrantes: Alison Schemitt, Cassiano Flores, Jose Junior, Mateus de Carvalho
------------------------------------------------------------------------------------------------------
...
-- Para  demonstrar  o  funcionamento  do  simula-se aqui os  3 programas pedidos no enunciado
